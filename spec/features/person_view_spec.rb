...
describe 'the person view', type: :feature do
  ...
  describe 'phone numbers list' do
  ...
  describe 'email addresses list' do

    before(:each) do
      person.email_addresses.create(address: 'john@doe.org')
    ...
    it 'adds a new email address' do
      ...
      page.fill_in('Address', with: 'john.d@yahoo.com')
      page.click_button('Create Email address')

      expect(current_path).to eq person_path(person)
      expect(page).to have_content 'john.d@yahoo.com'
    end
    ...
    it 'edits an email address' do
      ...
      first(:link, 'edit').click
      page.fill_in('Address', with: 'john@yahoo.com')
      page.click_button('Update Email address')

      expect(current_path).to eq person_path(person)
      expect(page).to have_content('john@yahoo.com')
